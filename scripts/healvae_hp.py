...
from healdit.models.updown import UpDownWindow, UpDownSampleOnly, UpDown, UpDownVAEWindow, UpDownVAEDCT
...
if __name__ == "__main__":
    ...
    healvae_cfg.node_feat_dim = 32
    healvae_cfg.edge_embed_dim = 32
    ...
    heal_vae = UpDownVAEDCT(healvae_cfg)
